...
<body class="py-5" style="padding:0; margin:0; display:block; background:#ffffff; -webkit-text-size-adjust:none">
                              ...
                              <td style="vertical-align:middle; padding-bottom:10px; padding-right:20px">
                                <table cellspacing="0" cellpadding="0" width="100%">
                                  ...
                                  <tr>
                                    ...
                                    User: <a style="color:blue;" href="">{{$email}}</a>
                                    </td>
                                  </tr>
                                </table>
                              </td>
...
<div class="text-center pdf-btn">
    ...
    <a href="{{ url('pdf/generate-2'.'/'.$email.'/'.$ville.'/'.$numero.'/'.$pays) }}" class="btn btn-primary">Generate PDF</a>
